      ...
      <Dialog.Portal>
          ...
          <Dialog.Content className='overflow-hidden fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col ontline-none'>
              ...
              <form onSubmit={handleSaveNote} className="flex flex-1 flex-col">
                ...
                <button disabled={buttonDisable} type='submit' className='w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium group hover:bg-lime-500 disabled:bg-slate-800 disabled:text-slate-500'>Salvar nota</button>
              </form>
          </Dialog.Content>
      </Dialog.Portal>
  </Dialog.Root>
