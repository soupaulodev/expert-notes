...
export function NewNoteCard ({ onNoteCreated }: NewNoteCardProps) {
    ...
    return (
      ...
      <Dialog.Portal>
          ...
          <Dialog.Content className='overflow-hidden fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col ontline-none'>
              ...
              <form className="flex flex-1 flex-col">
                ...
                {isRecording ? (
                  ...
                  <button
                    ...
                    className='w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium     group hover:bg-lime-500 disabled:bg-slate-800 disabled:text-slate-500'>
                      Salvar nota
                  </button>
                )}
              </form>
